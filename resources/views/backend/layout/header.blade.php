...
<head>
    ...
    <link href="{{asset('assets/css/form')}}" rel="stylesheet">
...
<header class="app-header navbar">
    ...
    <ul class="nav navbar-nav d-md-down-none">
        <li class="nav-item px-3">
            <a class="nav-link" href="{{route('backend')}}">Dashboard</a>
        </li>
        <li class="nav-item px-3">
            <a class="nav-link" href="{{route('backend')}}">Users</a>
        </li>
        <li class="nav-item px-3">
            <a class="nav-link" href="{{route('backend')}}">Settings</a>
        </li>
    </ul>
    <ul class="nav navbar-nav ml-auto">
        <li class="nav-item d-md-down-none">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="">
                    <i class="flaticon-logout"></i> Logout</a>
            </div>
