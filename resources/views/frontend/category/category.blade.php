                    ...
                    <div class="filter-widget">
                        ...
                        <ul class="category-menu">
                            ...
                            <li><a href="#">Man Wear</a>
                                <ul class="sub-menu">
                                    <li><a href="#">Formal <span>(2)</span></a></li>
                                    <li><a href="#">Casual<span>(56)</span></a></li>
                                    <li><a href="#">Party Wear<span>(36)</span></a></li>
                                </ul></li>
                            <li><a href="#">Children</a>
                                <ul class="sub-menu">
                                    <li><a href="#">Boy <span>(2)</span></a></li>
                                    <li><a href="#">Girl<span>(56)</span></a></li>
                                    <li><a href="#">Shoes<span>(36)</span></a></li>
                                </ul></li>
                            </li>
                            <li><a href="#">Bags & Purses</a>
                                <ul class="sub-menu">
                                    <li><a href="#">Men <span>(2)</span></a></li>
                                    <li><a href="#">Women<span>(56)</span></a></li>
                                    <li><a href="#">Unisex<span>(36)</span></a></li>
                                </ul></li></li>
                            <li><a href="#">Eyewear</a>
                                <ul class="sub-menu">
                                    <li><a href="#">Men <span>(2)</span></a></li>
